...
int main(){
    ...
    ReservationRequest req7(" Filosofia","segunda", 9, 11, 101); // Reserva que deve falhar por conflito de espaco
    ReservationRequest req8(" Sociologia","segunda", 11, 10, 20); // Reserva que deve falhar por horario invalido
    ...
    sistema.reserve(req7); // Tentativa de reserva que deve falhar por conflito de espaço
    sistema.reserve(req8); // Tentativa de reserva que deve falhar por horário inválido
